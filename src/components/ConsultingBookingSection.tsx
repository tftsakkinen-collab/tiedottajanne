...
export default function ConsultingBookingSection() {
  ...
  const [serviceType, setServiceType] = useState("Somenkonsultointi & Google Meet -tuntiohjaus (200 € / h)");
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7">
            <div className="liquid-glass rounded-3xl p-8 sm:p-10 space-y-8">
              ...
              <h3 className="text-2xl font-bold text-white tracking-tight">Jätä Tilaus- tai Yhteydenottopyyntö</h3>
              ...
              {status === "success" ? (
                <div className="p-8 rounded-2xl bg-emerald-950/40 border border-emerald-500/40 text-white space-y-3 shadow-lg">
                  ...
                  <p className="text-sm text-emerald-200 leading-relaxed">
                    Kiitos yhteydenotostasi. Viesti on vastaanotettu ja olemme sinuun pian yhteydessä sähköpostitse ({SITE_CONFIG.contactEmail}) aikataulujen sopimiseksi.
                  </p>
                  <button
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="matti@organisaatio.fi"
                        className="w-full px-4 py-3.5 rounded-2xl bg-white/[0.03] border border-white/15 text-white placeholder-white/40 focus:outline-none focus:border-[#00d2ff] text-sm transition-colors"
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      >
                        <option value="Somenkonsultointi & Google Meet -tuntiohjaus (200 € / h)">
                          Somenkonsultointi &amp; Google Meet -tuntiohjaus (200 € / h)
                        </option>
                        <option value="Räätälöity yrityskoulutus tai luento">
                          Räätälöity yrityskoulutus tai luento (Tarjouspyyntö)
                        </option>
                        <option value="Muu yhteydenotto / yhteistyö">
                          Muu yhteydenotto / yhteistyö
                        </option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-white/80 uppercase tracking-wider mb-1.5">
                      Viesti / Toiveet konsultoinnille tai koulutukselle *
                    </label>
                    <textarea
                      required
                      rows={4}
                      ...
                      placeholder="Kerro lyhyesti somesi tilanteesta, kysymyksistäsi tai toivotusta aikataulusta..."
                      className="w-full px-4 py-3.5 rounded-2xl bg-white/[0.03] border border-white/15 text-white placeholder-white/40 focus:outline-none focus:border-[#00d2ff] text-sm transition-colors"
                    />
                  </div>
                  ...
                  >
                    {loading ? (
                      ...
                      <>
                        ...
                        <span>Lähetä Yhteydenotto / Tilaus</span>
                      </>
                    )}
                  </button>
                </form>
