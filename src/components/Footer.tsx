      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-10 items-start">
          ...
          <div className="md:col-span-2 space-y-3">
            <h4 className="text-xs font-semibold text-white uppercase tracking-wider">Sivusto</h4>
            <ul className="space-y-2.5 text-xs">
              <li><Link href="/" className="hover:text-[#00d2ff] transition-colors">Etusivu</Link></li>
              <li><Link href="/palvelut" className="hover:text-[#00d2ff] transition-colors">Palvelut &amp; Hinnat</Link></li>
              <li><Link href="/referenssit" className="hover:text-[#00d2ff] transition-colors">Referenssit</Link></li>
              <li><Link href="/tyokalut" className="hover:text-[#00d2ff] transition-colors">Työkalut &amp; Resurssit</Link></li>
              <li><Link href="/yhteystiedot" className="hover:text-[#00d2ff] transition-colors">Yhteystiedot &amp; Tarjous</Link></li>
            </ul>
          </div>

          {/* Col 3: Kanavat */}
          <div className="md:col-span-3 space-y-3">
            <h4 className="text-xs font-semibold text-white uppercase tracking-wider">Kanavat &amp; Verkostot</h4>
