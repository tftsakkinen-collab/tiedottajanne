...
export const metadata: Metadata = {
  title: "Referenssikanavat & Näytöt | Tiedottajanne Oy",
  description: "Yli 1,1 miljoonaa orgaanista katselukertaa YouTubessa. Tutustu Tiedottajanne Oy:n referenssikanaviin, videofeediin ja todennettuun dataan.",
  alternates: {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="text-center space-y-4 max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#00d2ff]/30 bg-[#00d2ff]/10 text-[#00d2ff] text-xs font-semibold uppercase tracking-wider">
            ...
            <span>Käytännön Näytöt &amp; Proof of Work</span>
          </div>
          ...
          <p className="text-slate-200 text-base sm:text-lg leading-relaxed max-w-3xl mx-auto">
            Tiedottajanne Oy:n perustaja Janne Säkkinen on rakentanut nollasta yli 1,1 miljoonan katselukerran ja 5 380+ tilaajan orgaaniset somekanavat täysin ilman maksettua mainontaa. Kanaviin kuuluvat @tiedottajanne, @ft_sakkinen, @pt_sakkinen sekä @sakkinenjanne.
          </p>
        </div>
        ...
        <div className="liquid-glass rounded-3xl p-8 sm:p-12 border border-[#00d2ff]/30 text-center space-y-6 max-w-4xl mx-auto">
          ...
          <h2 className="text-2xl sm:text-4xl font-bold text-white tracking-tight">
            Haluatko saavuttaa vastaavia tuloksia omassa asiantuntijaviestinnässäsi?
          </h2>
          <p className="text-sm sm:text-base text-slate-200 max-w-2xl mx-auto leading-relaxed">
            Tutustu palveluihimme tai varaa suoraan henkilökohtainen Google Meet -tuntisparraus (200 € / h).
          </p>
