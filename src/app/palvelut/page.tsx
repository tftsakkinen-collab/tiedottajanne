...
export const metadata: Metadata = {
  title: "AI-Kotisivut SOTE-Ammatinharjoittajille — Rakenna Oma Digitaalinen Kotisi | Tiedottajanne Oy",
...
export default function PalvelutPage() {
  ...
  return (
    <div className="bg-[var(--bg)] text-[var(--text)]">
      ...
      {/* Oma maa / Digitaalinen koti -analyysi */}
      <VuokramaaVsOmaMaa />

      {/* The Godfather Offer: 499 € + 29 €/kk */}
      <GodfatherOffer />
